...
- **CODEX.md is a Codex adapter.** Use `drop-in/CODEX.md` when Codex is part of the workflow. It states what changes when the hooks are not around the tool calls.
